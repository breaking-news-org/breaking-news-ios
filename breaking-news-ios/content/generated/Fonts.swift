...
internal enum FontFamily {
  internal enum Roboto {
    ...
    internal static let boldCondensed = FontConvertible(name: "Roboto-BoldCondensed", family: "Roboto", path: "Roboto-BoldCondensed.ttf")
    internal static let boldCondensedItalic = FontConvertible(name: "Roboto-BoldCondensedItalic", family: "Roboto", path: "Roboto-BoldCondensedItalic.ttf")
    internal static let boldItalic = FontConvertible(name: "Roboto-BoldItalic", family: "Roboto", path: "Roboto-BoldItalic.ttf")
    internal static let condensed = FontConvertible(name: "Roboto-Condensed", family: "Roboto", path: "Roboto-Condensed.ttf")
    internal static let condensedItalic = FontConvertible(name: "Roboto-CondensedItalic", family: "Roboto", path: "Roboto-CondensedItalic.ttf")
    ...
    internal static let all: [FontConvertible] = [black, blackItalic, bold, boldCondensed, boldCondensedItalic, boldItalic, condensed, condensedItalic, italic, light, lightItalic, medium, mediumItalic, regular, thin, thinItalic]
  }
